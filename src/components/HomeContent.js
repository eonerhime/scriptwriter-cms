...
export default function HomeContent({ slug, initialData }) {
  ...
  // Component with React Query functionality
  function HomeContentWithQuery() {
    ...
    const updateHomeContent = updateContent.bind(null, slug);
